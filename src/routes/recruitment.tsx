...
function Page10() {
  return (
    <div className="min-h-screen bg-background text-on-background">
      ...
      <button className="flex-1 md:w-40 px-4 py-2 font-button-text text-button-text text-on-primary bg-electric-blue neo-border neo-shadow transition-all z-10" id="toggle-find">Find a Squad</button>
      <button className="flex-1 md:w-40 px-4 py-2 font-button-text text-button-text text-ink-black bg-surface hover:bg-surface-variant transition-all border-y-2 border-r-2 border-transparent hover:border-ink-black hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]" id="toggle-join">Join a Squad</button>
      </div>
      </header>
      ...
      <button className="mt-4 w-full bg-electric-blue text-on-primary neo-border py-2 font-button-text text-button-text hover:bg-primary-fixed-dim hover:text-ink-black transition-colors">Apply to Join</button>
      </article>
      ...
      <button className="mt-4 w-full bg-surface text-ink-black neo-border py-2 font-button-text text-button-text hover:bg-electric-blue hover:text-white transition-colors">Invite to Squad</button>
      </article>
      ...
      <button className="w-full md:w-auto bg-surface text-ink-black neo-border py-3 px-8 font-button-text text-button-text hover:bg-ink-black hover:text-white hover:border-white transition-colors neo-btn shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] hover:shadow-[6px_6px_0px_0px_rgba(255,255,255,1)]">Join Squad NOW</button>
      </div>
      </article>
      </div>
      {/*Load More*/}
      ...
      <p>© 2024 CodeSrijan. Built for the community.</p>
      </div>
