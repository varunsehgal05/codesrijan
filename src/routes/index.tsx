...
function Page14() {
  return (
    <div className="min-h-screen bg-background text-on-background">
      ...
      <a className="font-label-bold text-label-bold text-on-surface-variant hover:text-deep-navy transition-colors" href="/problems">Problems</a>
      <a className="font-label-bold text-label-bold text-on-surface-variant hover:text-deep-navy transition-colors" href="/recruitment">Recruitment</a>
      <a className="font-label-bold text-label-bold text-on-surface-variant hover:text-deep-navy transition-colors" href="/leaderboard">Leaderboard</a>
      </nav>
      <div className="flex items-center gap-4">
      <button className="hidden md:block font-label-bold text-label-bold text-on-surface-variant hover:text-deep-navy transition-colors">Sign In</button>
      <button className="bg-electric-blue text-pure-white font-label-bold text-label-bold px-6 py-2 brutal-border brutal-shadow brutal-shadow-hover transition-all duration-200">Register</button>
      </div>
      </div>
      </header>
      {/*Hero Section*/}
      ...
      <button className="bg-electric-blue text-pure-white font-label-bold text-label-bold px-8 py-4 brutal-border brutal-shadow brutal-shadow-hover transition-all duration-200 text-lg flex items-center gap-2">
                              Start Building <span className="material-symbols-outlined font-bold">arrow_forward</span>
      </button>
      <button className="bg-surface-container text-stark-black font-label-bold text-label-bold px-8 py-4 brutal-border brutal-shadow brutal-shadow-hover transition-all duration-200 text-lg">
                              View Schedule
                          </button>
      </div>
      </div>
      ...
      <span className="font-label-bold text-label-bold bg-secondary-fixed text-on-secondary-fixed px-3 py-1 rounded-full">#CodeSrijan2024</span>
      ...
      <p className="font-body-md text-body-md text-outline-variant">© 2024 CodeSrijan. Built with Electric Blue Energy.</p>
      </div>
      <nav className="flex flex-wrap justify-center gap-6 mt-6 md:mt-0">
      <a className="font-label-bold text-label-bold text-outline-variant hover:text-pure-white hover:underline decoration-2 underline-offset-4 transition-all cursor-pointer" href="/" >Community</a>
      <a className="font-label-bold text-label-bold text-outline-variant hover:text-pure-white hover:underline decoration-2 underline-offset-4 transition-all cursor-pointer" href="/" >Privacy Policy</a>
      <a className="font-label-bold text-label-bold text-outline-variant hover:text-pure-white hover:underline decoration-2 underline-offset-4 transition-all cursor-pointer" href="/" >Code of Conduct</a>
      <a className="font-label-bold text-label-bold text-outline-variant hover:text-pure-white hover:underline decoration-2 underline-offset-4 transition-all cursor-pointer" href="/" >Sponsors</a>
      </nav>
      </div>
      </footer>
    </div>
