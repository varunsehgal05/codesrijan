...
function Page3() {
  return (
    <div className="min-h-screen bg-background text-on-background">
      ...
      <a className="hover:text-electric-blue transition-colors duration-300" href="/" >Sponsors</a>
      <a className="hover:text-electric-blue transition-colors duration-300" href="/" >Community</a>
      ...
      <a className="hover:text-electric-blue transition-colors duration-300" href="/" >Privacy Policy</a>
      <a className="hover:text-electric-blue transition-colors duration-300" href="/" >Code of Conduct</a>
      </div>
