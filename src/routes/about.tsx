...
function Page11() {
  return (
    <div className="min-h-screen bg-background text-on-background">
      ...
      <div className="font-body-md text-body-md text-surface-bright opacity-80">© 2024 CodeSrijan. Built for the community.</div>
      </div>
      <div className="flex flex-wrap gap-6 font-body-md text-body-md">
      <a className="text-surface-variant hover:text-electric-blue transition-colors duration-300" href="/" >Sponsors</a>
      <a className="text-surface-variant hover:text-electric-blue transition-colors duration-300" href="/" >Community</a>
      ...
      <a className="text-surface-variant hover:text-electric-blue transition-colors duration-300" href="/" >Privacy Policy</a>
      <a className="text-surface-variant hover:text-electric-blue transition-colors duration-300" href="/" >Code of Conduct</a>
      </div>
      </div>
      </footer>
    </div>
